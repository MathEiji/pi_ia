...
class Bot:
    ...
    # Validador de heristica baseado no valor de cada peca e posicao do tabuleiro
    # https://www.chessprogramming.org/Simplified_Evaluation_Function

    # O codigo abaixo implementa essa heuristicas, desenvolvido por Anreas Stockl
